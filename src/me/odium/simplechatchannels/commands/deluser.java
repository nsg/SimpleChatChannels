...
public class deluser implements CommandExecutor {   
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)  {
    ...
    if(ChanTemp == false) {
      ...
      List<String> ChList = plugin.getStorageConfig().getStringList("Channels."+ChanName+".AccList"); // get the player list
      if (!ChList.contains(AddPlayName)) {
        ...
        plugin.getStorageConfig().set("Channels."+ChanName+".AccList", ChList); // set the new access list
        ...
        List<String> ChanList = plugin.getStorageConfig().getStringList("Channels."+ChanName+".AccList");
